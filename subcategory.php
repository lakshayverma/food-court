    ...
    <div class="products">
        <div class="container">
            <div class="col-md-9 product-w3ls-right">
                ...
                $a=$_GET["catid"];
                include "connect.php";
                $qu="select * from addsubcategory where category=$a";
                            ...
                            <div class="flipper agile-products">
                                <div class="front">
                                    <div class="agile-product-text agile-product-text2">
                                        <h5><?php print "<a href='product.php?subcatid=$ans[0]'>$ans[2]</a>"; ?></h5>
                                    </div>
                                    <?php print "<a href='product.php?subcatid=$ans[0]'><img src='product/$ans[3]' width='340px'></a>"; ?>
                                </div>
                                <div class="back">
                                    <div class="agile-product-text agile-product-text2">
                                        <h5><?php print "<a href='product.php?subcatid=$ans[0]'>$ans[2]</a>"; ?></h5>
                                    </div>
                                    <?php print "<a href='product.php?subcatid=$ans[0]'><img src='product/$ans[4]' width='340px'></a>"; ?>

                            ...
                            <div class="flipper agile-products">
                                <div class="front">
                                    <div class="agile-product-text agile-product-text2">
                                        <h5><?php print "<a href='subcategory.php?catid=$ans[0]'>$ans[1]</a>"; ?></h5>
                                    </div>
                                    <?php print "<a href='subcategory.php?catid=$ans[0]'><img src='product/$ans[2]' width='340px'></a>"; ?>
                                </div>
                                <div class="back">
                                    <div class="agile-product-text agile-product-text2">
                                        <h5><?php print "<a href='subcategory.php?catid=$ans[0]'>$ans[1]</a>"; ?></h5>
                                    </div>
                                    <?php print "<a href='subcategory.php?catid=$ans[0]'><img src='product/$ans[3]' width='340px'></a>"; ?>

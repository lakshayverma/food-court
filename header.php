    ...
    <div class="w3ls-header"><!-- header-one --> 
        <div class="container">
            ...
            <div class="w3ls-header-right">
                <ul> 
                    <li class="head-dpdn">
                        <a href="tel:+9501752609">
                            <i class="fa fa-phone" aria-hidden="true"></i> Call us: +9501752609
                        </a>
                    </li> 
                    <li class="head-dpdn">
                        <?php
                        if (isset($_SESSION["email"]))
                            print '<a title="Click here to change Password" href="changepass.php"><i class="fa fa-user" aria-hidden="true"></i>Welcome ' . ucwords($_SESSION["name"]) . '</a></li>';
                        else
                            print '<a href="#"><i class="fa fa-question-circle" aria-hidden="true"></i>Welcome Guest</a></li>';
                        ?>
                        <?php
                        if (isset($_SESSION["email"]))
                            print '<li class="head-dpdn">

...
<body>
    ...
    <!-- //breadcrumb -->
    <!--  about-page -->
    <table border="20" margin="6">
    <tr>
    <td>
    </br>
     <h2><span><center>ABOUT US</center></span></h2>
    </div>
    <div>
    </br>
    ...
    <div>
      ...
      <h2><span><center>Features</center></span></h2>
    </div>
    <div>
      <div><img src="images/about-us-page-image7.png" alt="1" width="79" height="79" /></div>
      <div>
        <div><p>Pay Online:Don't dig for change when the delivery boy turns up at your doorstep with your food. Simply order food online and choose our Online Payment mode and pay using your credit/debit card details! Simple, isn't it?</p></div>
      </div>
    </div>
    <div>
    </br>
      <div><img src="images/about-us-page-image8.png" alt="2" width="79" height="79" /></div>
      <div>
        <div><p>Plan Your Meals:&nbsp;If you are the ultimate dreamy foodie, you are probably dreaming about what food you will eat tomorrow even though you&rsquo;ve not had lunch today. We love such foodies, so we have enabled a feature on our platform that will allow you to pre-order and save time.</p></div>
      </div>
    </div>
    <div>
    </br>
      <div><img src="images/about-us-page-image9.png" alt="3" width="79" height="78" /></div>
      <div>
        <div><p>Check Order Status:&nbsp;If your food is delayed past the scheduled time, just go to &lsquo;Check order status link, enter your order code and Mobile number and get to know your order status on SMS in seconds</p>.</div>
      </div>
    </div>
    <div>
    </br>
      <div><img src="images/about-us-page-image10.png" alt="4" width="79" height="78" /></div>
      <div>
        <div><p>Phone Support:&nbsp;In case you need to speak to someone you can always call up one of our friendly support team on 080-600-00-600. Our phone support is available from 10am-11pm, 7 days a week.</p></div>
      </div>
    </div>
    <div>
    </br>
      <div><img src="images/about-us-page-image11.png" alt="5" width="79" height="79" /></div>
      <div>
        <div><p>Advanced Search Filter:&nbsp;If you want to make sure that the restaurant you are ordering from is purely vegetarian; has Air conditioning; a Kids section; serves Alcohol, is friendly or more, just check out our Advanced Search Filter and get all the information you want.</p></div>
      </div>
    </div>
    <div>
      <div>
    ...
    <div>
      <p>These are just some of the features we have. We leave the rest to be discovered by you.</p>
      <p>&nbsp;</p>
    </div>
    <div></div>
    <div>
